...
def start():
    ...
    fade_speed_min = .1 #larger number = faster fade
    fade_speed_max = .01

    fade_up_chance_ratio = [500,10000]  #a out of b chance of lighting up
    ...
    while(True):
        for i in range(0, crawl_speed):
            if i == 1:
                ...
                if bounce:
                    if min(crawl_end-1, num_pixels-1) in worm_body:
                        move_right = False
